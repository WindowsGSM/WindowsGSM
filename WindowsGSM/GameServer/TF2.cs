...
namespace WindowsGSM.GameServer
{
    class TF2
    {
        ...
        public TF2(Functions.ServerConfig serverData)
        {
        ...
        {
            //Download server.cfg
            string configPath = Functions.Path.GetServerFiles(_serverData.ServerID, @"tf\cfg\server.cfg");
        ...
        public string GetLocalBuild()
        {
            ...
            return steamCMD.GetLocalBuild(_serverData.ServerID, "232250");
        }

        public async Task<string> GetRemoteBuild()
        {
            var steamCMD = new Installer.SteamCMD();
            return await steamCMD.GetRemoteBuild("232250");
        }
    }
}
