...
namespace WindowsGSM.Games
{
    public class MCBE : IGameServer
    {
        ...
        public class CreateConfig
        {
            ...
            [CheckBox(Text = "I agree to the [Minecraft End User License Agreement](https://minecraft.net/terms) and [Privacy Policy](https://go.microsoft.com/fwlink/?LinkId=521839)", Required = true, RequiredError = "You must agree")]
