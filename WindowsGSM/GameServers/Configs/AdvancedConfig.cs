...
namespace WindowsGSM.GameServers.Configs
{
    public class AdvancedConfig
    {
        ...
        [CheckBox(Label = "Auto Start", HelperText = "Automatically start the server on boot.", IsSwitch = true)]
        public bool AutoStart { get; set; }

        [CheckBox(Label = "Auto Restart", HelperText = "Automatically restart the server when the server crashes unexpectedly.", IsSwitch = true)]
